    ...
    <section id="hero" className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 relative overflow-hidden">
      ...
      <div className="text-center relative z-10 px-4">
        <motion.div
          ...
          className="w-32 h-32 bg-gradient-to-r from-primary to-secondary rounded-full mx-auto mb-8 mt-12 flex items-center justify-center border-4 border-white/20"
        >
        ...
        >
          ...
          <a href="/Matheesha_Shehan_CV.pdf" download>
